...
struct SpokenNumbersTests {
    ...
    @Test(arguments: [
        ("до пяти человек", "до 5 человек"),
        ("у двух сервисов", "у 2 сервисов"),
        ("с двадцатью пятью участниками", "с 25 участниками"),
        ("около трёхсот тысяч", "около 300000"),
        ("около трехсот тысяч", "около 300000"),
        ("о двухстах пятидесяти", "о 250"),
        ("до сорока пяти минут", "до 45 минут"),
        ("с двадцатью семью", "с 27"),
        ("в трёх миллионах", "в 3000000"),
        ("ни одного бага", "ни одного бага"),
        ("одной строкой", "одной строкой"),
        ("сорока на ветке", "сорока на ветке"),
        ("свою семью", "свою семью"),
        ("начали с нуля", "начали с нуля"),
        ("с тысячей способов", "с тысячей способов"),
    ])
    func caseForms(input: String, expected: String) {
        #expect(SpokenNumbers.toDigits(input) == expected)
    }
